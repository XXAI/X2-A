...
class Requisicion extends Model {
	...
	protected $fillable = ['acta_id', 'numero', 'pedido', 'lotes', 'empresa', 'tipo_requisicion', 'dias_surtimiento', 'sub_total', 'gran_total', 'iva', 'firma_solicita','cargo_solicita', 'firma_director'];
